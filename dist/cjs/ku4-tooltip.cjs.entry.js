...
const Ku4Tooltip = class {
  constructor(hostRef) {
    ...
    this.hideTimeout = new index$1.Y(200).onTimeout(this._hide);
  }
  /**
  ...
  async show(element) {
    ...
    if (this.host.contains(element)) {
      ...
      this.scrollListener = index$1.L(() => this.calcualtePosition(element));
  ...
  calcualtePosition(target) {
    ...
    const targetBox = new index$1.B(left, top, width, height);
    const hostBox = new index$1.B(hleft, htop, hwidth, hheight);
    /**
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "arrow" }), index.h("div", { class: "content" }, index.h("slot", null))));
  }
  get host() { return index.getElement(this); }
};
Ku4Tooltip.style = ku4TooltipCss;

exports.ku4_tooltip = Ku4Tooltip;

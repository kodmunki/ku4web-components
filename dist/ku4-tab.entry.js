import { r as registerInstance, d as createEvent, h } from './core-9ffb600c.js';
...
const Ku4Tab = class {
    ...
    render() {
        ...
        return (h("button", { ref: (ref) => { this.buttonRef = ref; }, id: tabId, type: "button", role: "tab", class: `tab ${selected ? 'selected' : ''}`, onClick: e => this.tabClicked.emit(e), onKeyUp: e => this.tabKeyUp.emit(e), tabIndex: selected ? 0 : -1, "aria-controls": panel && panel.panelId, "aria-selected": selected ? 'true' : 'false' }, h("span", { class: "name" }, name)));
    }

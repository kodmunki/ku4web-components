...
import { t, E, Z } from './index-aa88697c.js';
...
const Ku4Validation = class {
  constructor(hostRef) {
    ...
    this.validated = createEvent(this, "ku4ValidationValidated", 7);
    /**
  ...
  handleInput() {
    t.isFalse(this.isValid) && this.assert();
  }
  handleChange() {
    t.isFalse(this.isValid) && this.assert();
  }
  ...
  componentWillLoad() {
    ...
    if (t.exists(this.input)) {
      ...
      const id = this.host.getAttribute('id') || E();

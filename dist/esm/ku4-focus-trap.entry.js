import { r as registerInstance, h as h$1, g as getElement } from './index-dc6f4989.js';
import { t, h } from './index-aa88697c.js';
import { o, l } from './index-ffdafbbd.js';
...
const { tab } = l;
const tabShift = l.tab.shift;
const tabAlt = l.tab.alt;
const tabAltShift = l.tab.alt.shift;
const Ku4FocusTrap = class {
  ...
  initialize() {
    ...
    this.elements = h([...queryTabbable(this.host), ...inclusions]);

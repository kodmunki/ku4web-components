...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            var _this = this;
            var NAMESPACE = 'ku4web-components';
            var BUILD = /* ku4web-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: true, cmpDidUnload: true, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: true, devTools: true, disconnectedCallback: false, dynamicImportShim: true, element: false, event: true, hasRenderFn: true, hostListener: true, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, noVdomRender: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: true, safari10: true, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: true };
            /*
             Stencil Runtime v1.9.0-18 | MIT Licensed | https://stenciljs.com
             */
            var scopeId;
            var contentRef;
            var hostTagName;
            ...
            var IS_NODE_WINDOWS_ENV = (IS_NODE_ENV &&
            ...
            var initializeDocumentHydrate = function (node, orgLocNodes) {
                if (node.nodeType === 1 /* ElementNode */) {
                    var i_2 = 0;
                    for (; i_2 < node.childNodes.length; i_2++) {
                        initializeDocumentHydrate(node.childNodes[i_2], orgLocNodes);
                    }
                    if (node.shadowRoot) {
                        for (i_2 = 0; i_2 < node.shadowRoot.childNodes.length; i_2++) {
                            initializeDocumentHydrate(node.shadowRoot.childNodes[i_2], orgLocNodes);
                        }
                    }
                }
                else if (node.nodeType === 8 /* CommentNode */) {
            ...
            var renderVdom = function (hostRef, renderFnResults) {
                ...
                if (BUILD.slotRelocation) {
                    if (checkSlotRelocate) {
                        ...
                        var refNode = void 0;
                        var i_4 = 0;
                        for (; i_4 < relocateNodes.length; i_4++) {
                            relocateData = relocateNodes[i_4];
                        ...
                        plt.$flags$ |= 1 /* isTmpDisconnected */;
                        for (i_4 = 0; i_4 < relocateNodes.length; i_4++) {
                            relocateData = relocateNodes[i_4];
                            nodeToRelocate = relocateData.$nodeToRelocate$;
            ...
            var slotReferenceDebugNode = function (slotVNode) { return doc.createComment("<slot" + (slotVNode.$name$ ?
                (' name="' + slotVNode.$name$) + '"' :
                '') + "> (host=" + hostTagName.toLowerCase() + ")"); };
            var originalLocationDebugNode = function (nodeToRelocate) { return doc.createComment("org-location for " +
            ...
            var appDidLoad = function (who) {
                ...
                if (BUILD.lifecycleDOMEvents) {
                    nextTick(function () { return emitLifecycleEvent(doc, 'appload'); });
                }
            ...
            var addHydratedFlag = function (elm) { return BUILD.hydratedClass ?
            ...
            var serverSideConnected = function (elm) {
                ...
                if (children != null) {
                    for (var i_5 = 0, ii = children.length; i_5 < ii; i_5++) {
                        var childElm = children[i_5];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, module.import('./shadow-css-47ad00b3.system.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
                        case 5:
                            style_1 = _a.sent();
                            _a.label = 6;
                        case 6:
            ...
            var connectedCallback = function (elm) {
                if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
                    ...
                    if (BUILD.hostListener && cmpMeta_1.$listeners$) {
                    ...
                    if (!(hostRef_1.$flags$ & 1 /* hasConnected */)) {
                        ...
                        if (BUILD.hydrateClientSide) {
                            ...
                            if (hostId) {
                                if (BUILD.shadowDom && supportsShadowDom && cmpMeta_1.$flags$ & 1 /* shadowDomEncapsulation */) {
                        ...
                        if (BUILD.slotRelocation && !hostId) {
                            ...
                            if ((BUILD.hydrateServerSide) ||
                                ((BUILD.slot || BUILD.shadowDom) && cmpMeta_1.$flags$ & (4 /* hasSlotRelocation */ | 8 /* needsShadowDomShim */))) {
            ...
            var setContentReference = function (elm) {
                ...
                // create a node to represent where the original
                // content was first placed, which is useful later on
                var contentRefElm = elm['s-cr'] = doc.createComment(BUILD.isDebug
            ...
            var cloneNodeFix = function (HostElementPrototype) {
                var orgCloneNode = HostElementPrototype.cloneNode;
                HostElementPrototype.cloneNode = function (deep) {
                    var srcNode = this;
                    var isShadowDom = BUILD.shadowDom ? srcNode.shadowRoot && supportsShadowDom : false;
            ...
            var appendChildSlotFix = function (HostElementPrototype) {
                HostElementPrototype.__appendChild = HostElementPrototype.appendChild;
                HostElementPrototype.appendChild = function (newChild) {
                    var slotName = newChild['s-sn'] = getSlotName(newChild);
                    var slotNode = getHostSlotNode(this, slotName);
                    if (slotNode) {
            ...
            var getSlotName = function (node) { return (node['s-sn']) ||
                (node.nodeType === 1 && node.getAttribute('slot')) || ''; };
            var getHostSlotNode = function (elm, slotName) {
                var childNodes = elm.childNodes;
                var i = 0;
                var childNode;
            ...
            var createEvent = exports('c', function (ref, name, flags) {
                ...
                return {
                    emit: function (detail) {
                        ...
                        var ev = new (BUILD.hydrateServerSide ? win.CustomEvent : CustomEvent)(name, {
            ...
            /*
             Stencil Client Platform v1.9.0-18 | MIT Licensed | https://stenciljs.com
             */
            ...
            var supportsShadowDom = BUILD.shadowDomShim ? (BUILD.shadowDom) ? /*@__PURE__*/ (function () { return (doc.head.attachShadow + '').indexOf('[native') > -1; })() : false : true;
            ...
            var STENCIL_DEV_MODE = ['%cstencil', 'color: white;background:#4c47ff;font-weight: bold; font-size:10px; padding:2px 6px; border-radius: 5px'];
            ...
            var IS_NODE_ENV$1 = (typeof global !== 'undefined' &&
                typeof require === 'function' &&
                !!global.process &&
                Array.isArray(global.process.argv) &&
                typeof __filename === 'string' &&
                (!global.origin || typeof global.origin !== 'string'));
            var IS_NODE_WINDOWS_ENV$1 = (IS_NODE_ENV$1 &&
                global.process.platform === 'win32');
            ...
            var patchEsm = exports('a', function () {
                ...
                if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-31b76af0.system.js').then(function () {
            ...
            var patchBrowser = exports('p', function () {
                ...
                var scriptElm = (BUILD.scriptDataOpts || BUILD.safari10 || BUILD.dynamicImportShim) ?
                    Array.from(doc.querySelectorAll('script')).find(function (s) { return (new RegExp("/" + NAMESPACE + "(\\.esm)?\\.js($|\\?|#)").test(s.src) ||
                ...
                if (BUILD.safari10 && 'onbeforeload' in scriptElm && !history.scrollRestoration && false /* IS_SYSTEM_JS_BUILD */) {
                ...
                if (!BUILD.safari10 && importMeta !== '') {
                    ...
                    if (BUILD.dynamicImportShim && !win.customElements) {
                        ...
                        // @ts-ignore
                        return module.import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-6e5d3270.system.js').then(function () { return opts; });
                    }
                }

System.register(['./index-c708be46.system.js'], function (exports) {
    'use strict';
    var dist$1, createCommonjsModule, unwrapExports;
    return {
        ...
        execute: function () {
                ...
                function () {
                    ...
                    _createClass(Event, null, [{
                            ...
                            value: function remove(id) {
                                var _evt$id = _evt[id], element = _evt$id.element, event = _evt$id.event, callback = _evt$id.callback, options = _evt$id.options;
            ...
            var Event = unwrapExports(Event_1);
            ...
            var Document = unwrapExports(Document_1);
            ...
            var Window = unwrapExports(Window_1);
            ...
            var Keyboard = unwrapExports(Keyboard_1);
                ...
                function () {
                    ...
                    _createClass(Swipe, [{
                            ...
                            value: function didTouchStart(_ref) {
                                var _ref$touches = _slicedToArray(_ref.touches, 1), touch = _ref$touches[0];
                                this.touchStartPoint = new dist$1.Point(touch.pageX, touch.pageY);
                            }
                        }, {
                            key: "didTouchEnd",
                            value: function didTouchEnd(e) {
                                var _e$changedTouches = _slicedToArray(e.changedTouches, 1), touch = _e$changedTouches[0];
                            ...
                            value: function didTouchMove(e) {
                                var _e$touches = _slicedToArray(e.touches, 1), touch = _e$touches[0];
                                var touchStartPoint = this.touchStartPoint;
                                var touchEndPoint = new dist$1.Point(touch.pageX, touch.pageY);
                                this.didMove({
            ...
            var Swipe = unwrapExports(Swipe_1);
            ...
            var dist_1 = exports('c', dist.Document);
            var dist_2 = exports('b', dist.Event);
            var dist_3 = exports('a', dist.Key);
            var dist_4 = exports('d', dist.Swipe);
        }
    };
});

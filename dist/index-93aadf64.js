    ...
    if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_ku4web_components('./shadow-css-119ebbed.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    return __sc_import_ku4web_components(
...
const IS_NODE_ENV$1 = (typeof global !== 'undefined' &&
    typeof require === 'function' &&
    !!global.process &&
    Array.isArray(global.process.argv) &&
    typeof __filename === 'string' &&
    (!global.origin || typeof global.origin !== 'string'));
const IS_NODE_WINDOWS_ENV$1 = (IS_NODE_ENV$1 &&
    global.process.platform === 'win32');
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_ku4web_components(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-98948a28.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_ku4web_components(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-12e74d00.js').then(() => opts);
        }
    }

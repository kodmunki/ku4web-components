...
import { a as dist_3, b as dist_2 } from './index-082ab942.js';
...
const Ku4FocusTrap = class {
    ...
    removeEventListeners(elements) {
        ...
        elements.forEach(element => element.removeEventListener('keyup', dist_2.mute, true));
    ...
    createTag(type) {
        ...
        trap.setAttribute('style', 'position: static; display: inline; margin: 0; outline: none');
        return trap;
    }
    initialize() {

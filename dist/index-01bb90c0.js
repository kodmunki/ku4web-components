    ...
    if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_ku4web_components('./shadow-css-21f42882.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_ku4web_components(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-212aa775.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_ku4web_components(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-6918aa82.js').then(() => opts);
        }
    }
